...
const inspectionData: DeviceInspection = {
  //   deviceId: 'PortableICU',
  //   deviceName: 'ポータブル装置 (ICU)',
  inspections: [
    {
      category: ['CALNEO Go ICU'],
      items: [
        {
          label: 'コンソールのシャットダウン確認',
        ...
        { label: 'ゴミ箱のゴミ収集', frequency: 'last-WeekdayOfWeek' },
        {
          label: 'バッテリーのローテーション',
...
const PortableICU: FC<PortableICUProps> = ({
  formatDate,
  totalHolidays,
  displayRoom,
  dailyChecklistYear,
